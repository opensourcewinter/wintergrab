...
- **`Provider(name: str, endpoint: str | None = None, endpoint_variable: str | None = None, key_variable: str | None = None, key_header: str | None = None, key_param: str | None = None, params: Mapping[str, str] = ..., variables: Mapping[str, str] = ..., query_param: str = 'q', size_param: str | None = None, size: int = 10, page_param: str = 'page', page_by: str = 'number', results_path: str | None = None, type_field: str | None = None, modules: Mapping[str, str] = ..., order_path: str | None = None)`** (class). How to ask a search API: its endpoint, the key, how its pages go, and where its answers hold what.
  - `page_value(self, index: int) -> int`: The page parameter's value for page ``index`` (0 first).
- **`SearchAnswer(query: str, provider: str, results: list[SearchResult] = ..., modules: list[SearchResult] = ..., related: list[str] = ..., questions: list[dict[str, str]] = ..., total: int | None = None, notes: list[str] = ...)`** (class). What a search gave: its web results, the page's other results and boxes, and what else was said.
  - `records(self) -> list[dict[str, Any]]`: Its results and modules as records (:meth:`SearchResult.to_dict`), the web results first.
- **`SearchResult(query: str, position: int, url: str = '', title: str = '', snippet: str = '', domain: str = '', date: str | None = None, source: str = '', fetched: str = '', type: str = 'web', rank: int | None = None, details: dict[str, Any] = ...)`** (class). One result of a search: its query, its position (1 first, across pages), and what it links to.
